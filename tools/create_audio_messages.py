...
if __name__ == '__main__':
    ...
    if os.path.isdir(targetDir):
        print("Directory `" + targetDir + "` already exists. But Ok.")
    else:
        os.mkdir(targetDir)
    if os.path.isdir(targetDir + '/advert'):
        shutil.rmtree(targetDir + '/advert')
    os.mkdir(targetDir + '/advert')
    if os.path.isdir(targetDir + '/mp3'):
        shutil.rmtree(targetDir + '/mp3')
    else:
